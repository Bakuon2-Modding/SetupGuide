...
3. コピーすると「bakuon2-コピー」というフォルダ名で作成されるので、「bakuon2_mod」等の名前に変更する。名前は日本語を含まないこと。
...
アセットバンドルデータとは、ゲームの3Dモデル、シーン、BGMなどを含む1GB超の大容量データです。ゲーム初回起動時にサーバーからダウンロードされるデータです。
...
3. (任意) `%USERPROFILE%/AppData/LocalLow/Unity/bakumatu_bakuon2`
